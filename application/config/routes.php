...
$route['user/edit'] = 'frontend/user/editprofile';

$route['user/referuser'] = 'frontend/user/referuser';
$route['user/referlist'] = 'frontend/user/referlist';
